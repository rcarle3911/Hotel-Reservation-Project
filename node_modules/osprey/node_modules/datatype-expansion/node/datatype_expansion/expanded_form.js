...
return cljs.core.not_EQ_.call(null,p1__15826_SHARP_,new cljs.core.Keyword(null,"TYPE_EXPRESSION","TYPE_EXPRESSION",260003064));
});})(ast,context))
,ast);
...
var G__15834 = cljs.core.first.call(null,type);
var G__15835 = context;
ast = G__15834;
context = G__15835;
continue;
} else {
var pred__15831 = cljs.core._EQ_;
var expr__15832 = cljs.core.first.call(null,type);
if(cljs.core.truth_(pred__15831.call(null,new cljs.core.Keyword(null,"UNION_TYPE","UNION_TYPE",-1311432052),expr__15832))){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"union",new cljs.core.Keyword(null,"anyOf","anyOf",-1046092155),cljs.core.mapv.call(null,((function (ast,context,pred__15831,expr__15832,type){
return (function (p1__15827_SHARP_){
return datatype_expansion$expanded_form$ast__GT_type.call(null,p1__15827_SHARP_,context);
});})(ast,context,pred__15831,expr__15832,type))
,cljs.core.rest.call(null,type))], null);
} else {
if(cljs.core.truth_(pred__15831.call(null,new cljs.core.Keyword(null,"SCALAR_TYPE","SCALAR_TYPE",-784669066),expr__15832))){
...
if(cljs.core.truth_(pred__15831.call(null,new cljs.core.Keyword(null,"ARRAY_TYPE","ARRAY_TYPE",-473571449),expr__15832))){
...
if(cljs.core.truth_(pred__15831.call(null,new cljs.core.Keyword(null,"TYPE_NAME","TYPE_NAME",-245619732),expr__15832))){
...
}catch (e15837){if((e15837 instanceof Error)){
var ex = e15837;
return null;
} else {
throw e15837;
...
datatype_expansion.expanded_form.setup_context = (function datatype_expansion$expanded_form$setup_context(p__15838){
var map__15841 = p__15838;
var map__15841__$1 = ((((!((map__15841 == null)))?((((map__15841.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15841.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15841):map__15841);
var context = map__15841__$1;
var path = cljs.core.get.call(null,map__15841__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var args15843 = [];
var len__7291__auto___15848 = arguments.length;
var i__7292__auto___15849 = (0);
while(true){
if((i__7292__auto___15849 < len__7291__auto___15848)){
args15843.push((arguments[i__7292__auto___15849]));

var G__15850 = (i__7292__auto___15849 + (1));
i__7292__auto___15849 = G__15850;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,node,facet_name,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__15846){
var vec__15847 = p__15846;
var k = cljs.core.nth.call(null,vec__15847,(0),null);
var v = cljs.core.nth.call(null,vec__15847,(1),null);
...
var type_node__$1 = (((cljs.core.map_QMARK_.call(null,type_node)) && (cljs.core.some_QMARK_.call(null,new cljs.core.Keyword(null,"properties","properties",685819552).cljs$core$IFn$_invoke$arity$1(type_node))))?cljs.core.assoc.call(null,type_node,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__15860){
...
return datatype_expansion$expanded_form$expanded_form_inner.call(null,p1__15856_SHARP_,context);
});})(type_node__$1,type))
...
return datatype_expansion$expanded_form$expanded_form_inner.call(null,p1__15857_SHARP_,context);
});})(type_node__$1,type))
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__15865){
...
return cljs.core.mapv.call(null,(function (p1__15862_SHARP_){
return datatype_expansion$expanded_form$add_fixpoints.call(null,p1__15862_SHARP_,fixpoints,num_fixpoints);
}),t);
} else {
return t;
...
var k = cljs.core.nth.call(null,vec__15870,(0),null);
var v = cljs.core.nth.call(null,vec__15870,(1),null);
...
//# sourceMappingURL=expanded_form.js.map?rel=1475853207192