...
var args16685 = [];
var len__7291__auto___16690 = arguments.length;
var i__7292__auto___16691 = (0);
while(true){
if((i__7292__auto___16691 < len__7291__auto___16690)){
args16685.push((arguments[i__7292__auto___16691]));

var G__16692 = (i__7292__auto___16691 + (1));
i__7292__auto___16691 = G__16692;
continue;
} else {
}
break;
...
var vec__16688 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__16688,(0),null);
var end = cljs.core.nth.call(null,vec__16688,(1),null);
...
var vec__16689 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__16689,(0),null);
var end = cljs.core.nth.call(null,vec__16689,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$.call(null,end);
} else {
...
var vec__16695 = instaparse.viz.span.call(null,parse);
var start = cljs.core.nth.call(null,vec__16695,(0),null);
var end = cljs.core.nth.call(null,vec__16695,(1),null);
...
var G__16696 = cljs.core.next.call(null,parses__$1);
parses__$1 = G__16696;
continue;
}
...
var args16697 = [];
var len__7291__auto___16704 = arguments.length;
var i__7292__auto___16705 = (0);
while(true){
if((i__7292__auto___16705 < len__7291__auto___16704)){
args16697.push((arguments[i__7292__auto___16705]));

var G__16706 = (i__7292__auto___16705 + (1));
i__7292__auto___16705 = G__16706;
continue;
} else {
}
break;
...
var G__16701 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16702 = G__16701;
var parse = cljs.core.nth.call(null,vec__16702,(0),null);
var end = cljs.core.nth.call(null,vec__16702,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16702,(2),null);
var selection = vec__16702;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__16701__$1 = G__16701;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__16703 = G__16701__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16703,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16703,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16703,(2),null);
var selection__$1 = vec__16703;
...
var G__16708 = cljs.core.long$.call(null,end__$1);
var G__16709 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16710 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16708;
parses__$1 = G__16709;
G__16701__$1 = G__16710;
continue;
...
var args16711 = [];
var len__7291__auto___16718 = arguments.length;
var i__7292__auto___16719 = (0);
while(true){
if((i__7292__auto___16719 < len__7291__auto___16718)){
args16711.push((arguments[i__7292__auto___16719]));

var G__16720 = (i__7292__auto___16719 + (1));
i__7292__auto___16719 = G__16720;
continue;
} else {
}
break;
...
var G__16715 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16716 = G__16715;
var parse = cljs.core.nth.call(null,vec__16716,(0),null);
var end = cljs.core.nth.call(null,vec__16716,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16716,(2),null);
var selection = vec__16716;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__16715__$1 = G__16715;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__16717 = G__16715__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16717,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16717,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16717,(2),null);
var selection__$1 = vec__16717;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__16722 = cljs.core.long$.call(null,end__$1);
var G__16723 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16724 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16722;
parses__$1 = G__16723;
G__16715__$1 = G__16724;
continue;
...
var args16725 = [];
var len__7291__auto___16732 = arguments.length;
var i__7292__auto___16733 = (0);
while(true){
if((i__7292__auto___16733 < len__7291__auto___16732)){
args16725.push((arguments[i__7292__auto___16733]));

var G__16734 = (i__7292__auto___16733 + (1));
i__7292__auto___16733 = G__16734;
continue;
} else {
}
break;
...
var index__$1 = cljs.core.long$.call(null,index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__16729 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,index__$1,first_result);
var vec__16730 = G__16729;
var parse = cljs.core.nth.call(null,vec__16730,(0),null);
var end = cljs.core.nth.call(null,vec__16730,(1),null);
var follow_ups = cljs.core.nth.call(null,vec__16730,(2),null);
var selection = vec__16730;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__16729__$1 = G__16729;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__16731 = G__16729__$1;
var parse__$1 = cljs.core.nth.call(null,vec__16731,(0),null);
var end__$1 = cljs.core.nth.call(null,vec__16731,(1),null);
var follow_ups__$1 = cljs.core.nth.call(null,vec__16731,(2),null);
var selection__$1 = vec__16731;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.call(null,index__$3,end__$1)){
...
var G__16736 = cljs.core.long$.call(null,end__$1);
var G__16737 = instaparse.auto_flatten_seq.conj_flat.call(null,parses__$2,parse__$1);
var G__16738 = instaparse.repeat.select_parse.call(null,grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__16736;
parses__$1 = G__16737;
G__16729__$1 = G__16738;
continue;
...
var args16739 = [];
var len__7291__auto___16742 = arguments.length;
var i__7292__auto___16743 = (0);
while(true){
if((i__7292__auto___16743 < len__7291__auto___16742)){
args16739.push((arguments[i__7292__auto___16743]));

var G__16744 = (i__7292__auto___16743 + (1));
i__7292__auto___16743 = G__16744;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args16739.length)].join('')));
...
var G__16747 = (((output_format instanceof cljs.core.Keyword))?output_format.fqn:null);
switch (G__16747) {
case "enlive":
...
//# sourceMappingURL=repeat.js.map?rel=1475748719194