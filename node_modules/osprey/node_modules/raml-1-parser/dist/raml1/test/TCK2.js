...
describe('Complete TCK Test Set', function () {
    ...
    describe('RAML08/Examples', function () {
        ...
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML08/Examples/test003/api.raml");
        });
    });
    ...
    describe('RAML10/Annotations', function () {
        ...
        it("test039/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test039/api.raml");
        });
        it("test040/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test040/api.raml");
        });
        it("test041/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test041/api.raml");
        });
        it("test042/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test042/api.raml");
        });
        it("test043/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test043/api.raml");
        });
        it("test044/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test044/api.raml");
        });
    });
    ...
    describe('RAML10/Examples', function () {
        ...
        it("test064/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test064/api.raml");
        });
        it("test065/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test065/api.raml");
        });
        it("test066/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test066/api.raml");
        });
    });
    ...
    describe('RAML10/Extensions', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Extensions/test001/api.raml", ["TCK/RAML10/Extensions/test001/e1.raml", "TCK/RAML10/Extensions/test001/e2.raml"]);
        });
    });
    describe('RAML10/Fragments', function () {
        ...
        it("test010/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test010/api.raml");
        });
    });
    describe('RAML10/Libraries', function () {
        ...
        it("test005/lib1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Libraries/test005/lib1.raml");
        });
        it("test005/lib2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Libraries/test005/lib2.raml");
        });
    });
    ...
    describe('RAML10/Methods', function () {
        ...
        it("test013/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Methods/test013/api.raml");
        });
    });
    describe('RAML10/Overlays', function () {
        ...
        it("test030/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Overlays/test030/api.raml", ["TCK/RAML10/Overlays/test030/o1.raml", "TCK/RAML10/Overlays/test030/o2.raml"]);
        });
        it("test031/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Overlays/test031/api.raml", ["TCK/RAML10/Overlays/test031/o1.raml", "TCK/RAML10/Overlays/test031/o2.raml"]);
        });
    });
    ...
    describe('RAML10/ReferencesPatching/Fragments', function () {
        ...
        it("test009/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test009/lib.raml");
        });
    });
    describe('RAML10/ReferencesPatching/ResourceTypes', function () {
        ...
        it("test006/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test006/api.raml");
        });
    });
    describe('RAML10/ReferencesPatching/SecuritySchemes', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/SecuritySchemes/test001/api.raml");
        });
    });
    ...
    describe('RAML10/ResourceTypes', function () {
        ...
        it("test012/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ResourceTypes/test012/api.raml");
        });
        it("test013/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ResourceTypes/test013/api.raml");
        });
    });
    ...
    describe('RAML10/Specifications', function () {
        ...
        it("world-music-api/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Specifications/world-music-api/api.raml");
        });
    });
    describe('RAML10/TemplateTransformers', function () {
        ...
        it("test002/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/TemplateTransformers/test002/api.raml");
        });
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/TemplateTransformers/test003/api.raml");
        });
    });
    ...
    describe('RAML10/Types', function () {
        ...
        it("test035/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test035/api.raml");
        });
        it("test036/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test036/api.raml");
        });
    });
    ...
    describe('RAML10/Types/ObjectTypes', function () {
        ...
        it("test024/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test024/api.raml");
        });
        it("test025/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test025/api.raml");
        });
        it("test026/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test026/api.raml");
        });
        it("test027/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test027/api.raml");
        });
        it("test028/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test028/api.raml");
        });
    });
    describe('RAML10/Types/PropertyOverride', function () {
        ...
        it("test011/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/PropertyOverride/test011/api.raml");
        });
    });
    ...
    describe('RAML10/jsonscheme', function () {
        it("test1/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test1/apiInvalid.raml");
        });
        it("test1/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test1/apiValid.raml");
        });
        it("test10/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test10/apiInvalid.raml");
        });
        it("test10/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test10/apiValid.raml");
        });
        it("test11/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test11/apiInvalid.raml");
        });
        it("test11/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test11/apiValid.raml");
        });
        it("test2/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test2/apiInvalid.raml");
        });
        it("test2/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test2/apiValid.raml");
        });
        it("test3/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test3/apiInvalid.raml");
        });
        it("test3/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test3/apiValid.raml");
        });
        it("test4/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test4/apiInvalid.raml");
        });
        it("test4/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test4/apiValid.raml");
        });
        it("test5/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test5/apiInvalid.raml");
        });
        it("test5/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test5/apiValid.raml");
        });
        it("test6/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test6/apiInvalid.raml");
        });
        it("test6/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test6/apiValid.raml");
        });
        it("test7/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test7/apiInvalid.raml");
        });
        it("test7/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test7/apiValid.raml");
        });
        it("test8/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test8/apiInvalid.raml");
        });
        it("test8/apiInvalid0.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test8/apiInvalid0.raml");
        });
        it("test8/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test8/apiValid.raml");
        });
        it("test8/apiValid0.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test8/apiValid0.raml");
        });
        it("test9/apiInvalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test9/apiInvalid.raml");
        });
        it("test9/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/jsonscheme/test9/apiValid.raml");
        });
    });
