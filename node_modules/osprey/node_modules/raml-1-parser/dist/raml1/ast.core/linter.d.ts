...
export declare function createIssue1(messageEntry: any, parameters: any, node: hl.IParseResult, isWarning?: boolean): hl.ValidationIssue;
export declare function createIssue(issueCode: string, message: string, node: hl.IParseResult, isWarning?: boolean): hl.ValidationIssue;
export declare function createLLIssue(issueCode: string, message: string, node: ll.ILowLevelASTNode, rootCalculationAnchor: hl.IParseResult, isWarning?: boolean, p?: boolean): hl.ValidationIssue;
