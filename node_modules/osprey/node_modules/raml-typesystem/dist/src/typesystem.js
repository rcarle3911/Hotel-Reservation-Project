...
var Status = (function () {
    ...
    Status.CODE_INCORRECT_DISCRIMINATOR = 5;
    Status.CODE_MISSING_DISCRIMINATOR = 6;
    Status.ERROR = 3;
    Status.INFO = 1;
    Status.OK = 0;
    Status.WARNING = 2;
...
var AbstractType = (function () {
    ...
    AbstractType.prototype.validateFacets = function (rs) {
        ...
        if (Object.getOwnPropertyNames(rfds).length > 0) {
            rs.addSubStatus(new Status(Status.ERROR, 0, "Missing required facets: " + Object.keys(rfds).map(function (x) { return ("'" + x + "'"); }).join(","), this));
        }
    };
    ;
    ...
    if (discriminator.length != 0) {
        ...
        if (dVal) {
            if (i.hasOwnProperty(dName)) {
                var adVal = i[dName];
                if (adVal != dVal) {
                    var wrng = new Status(Status.WARNING, Status.CODE_INCORRECT_DISCRIMINATOR, "None of the '" + owner.name() + "' type known subtypes declare '" + adVal + "' as value of discriminating property '" + dName + "'.", this);
                ...
                var err = new Status(Status.ERROR, Status.CODE_MISSING_DISCRIMINATOR, "Instance of '" + owner.name() + "' subtype misses value of the discriminating property '" + dName + "'.", this);
